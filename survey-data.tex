...
with redundancy and verification mechanism so as to minimize chances of data loss. Such implementaion may be needed,
...
sites of smaller scale, to be confugured and used mainly for analysis of the data (they are also used
to handle a large fraction of Monte Carlo simulations workload). Smaller installation and what is termed ``non-pledged resources'' 
belong to Tier-3 in this scheme, implying a more \textit{ad hoc} approach to data distribution and handling of computational
...
limits of storage capacity andl network throughput were the primary drivers in the MONARC model. In particular,
