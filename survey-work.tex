...
\item Tight coupling of workflow and workload management with data handling at all levels of the overall system.
\end{itemize}

In the following, we  bring together a few standard definitions and real life examples to help clarify relationships among distinct elements of this domain and make appropriate recommendations.
...
\textbf{FIXME}\\
The first item on this list is very important in terms of the overall system usability. Perhaps the most successful and elegant solution to these issues is the introduction of \textit{late binding}
