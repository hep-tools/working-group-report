...
relationships among distinct elements of this domain and form the basis for possible recommendations.
...
\subsubsection{LHC}
There are a variety of Workflow and Workload Management systems deployed in recent past and at present. Our goal here is not to compile an exhaustive list of such systems but rather pick a (very)
few representative examples, which have been deployed and utilized \textit{at scale}. Let's start with the LHC experiments:
