...
Rapid evolution of the field such as HEP and time pressures to deliver in this competetive environment led to design and implementation of complete (to varying degrees) and successful solutions
to satisfy the needs of specific  research projects. This had two consequences:
...
We observe that there are essentially \textbf{three interconnected domains} involved: Workflow Management, Workload Management, and Data Management.
...
based on virtualization and Cloud API which essentially extrend Grid resources with on-demand, elastic Cloud capability~\cite{star_acat11}.
...
\begin{center}
  \begin{tabular}{ c | c | c | c }
    ...
    CMS  & GlideinWMS~\cite{glideinwms} & Crab3~\cite{crab3_chep12} & PhEDEx~\cite{phedex_chep10}\\ \hline
